...
//   // Voice Activity Detection with better sensitivity
//   const detectVoiceActivity = useCallback(() => {
//     if (!analyserRef.current || !isVoiceChatActive || isSpeaking) return;
...
//     const VOICE_THRESHOLD = 0.005; // Very sensitive
//     const SILENCE_DURATION = 2000; // 2 seconds

//     console.log("Voice level:", normalizedLevel, "Recording:", recording, "Speaking:", isSpeaking);
...
//         console.log("🎤 Voice detected! Starting recording...", normalizedLevel);
//         startVoiceChatRecording();
//       }
//     } else if (recording && !isSpeaking) {
...
//       }
//     }
//   }, [isVoiceChatActive, recording, isSpeaking, silenceTimer]);

//   const startVoiceChatRecording = async () => {
//     if (isSpeaking || recording) return;
...
//         const botMessage: ChatMessage = {
//           id: Date.now() + 1,
//           text: "Hello! Welcome to magent AI",
//           sender: "bot",
//           timestamp: new Date().toLocaleTimeString([], {
//             hour: "2-digit",
//             minute: "2-digit",
...
//       analyserRef.current.fftSize = 1024; // Increased for better sensitivity
...
//     vadIntervalRef.current = setInterval(detectVoiceActivity, 50);
...
//       // Test the microphone immediately
//       setTimeout(() => {
//         console.log("🔊 Testing microphone - please speak now...");
//       }, 1000);
...
//                   {recording ? "Stop speaking to send" : "Start speaking to record"}
//                 </div>
//               </div>
//             </div>
//           )}
...
//               >
//                 {recording ? <X size={22} /> : <MicIcon size={22} />}
//               </button>
//             )}
...
//                 className="bg-[#D7D7D7] rounded-full p-[10px] flex items-center font-bold justify-center bg-primary text-white hover:bg-white hover:text-black transition"
//               >
//                 {voiceChatEnabled ? <X size={22} /> : <AudioLines size={22} />}
//               </Button>
//             )}
//           </div>
//         </div>
