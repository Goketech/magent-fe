...
key={campaign._id}>
  <td className="py-3 px-4 text-[10px] md:text-xs">{capitalizeEachWord(campaign?.name)}</td>
  <td className="py-3 px-4 text-[10px] md:text-xs">{capitalizeEachWord(campaign?.name)}</td>
  <td className="py-3 px-4 text-[10px] md:text-xs">{capitalizeEachWord(campaign?.goals)}</td>
  <td className="py-3 px-4 text-[10px] md:text-xs">{capitalizeEachWord('kpis' in campaign ? (campaign.kpis === "" ? "N/A" : campaign.kpis) : "N/A")}</td>
  ...
  <td className="py-3 px-4 text-[10px] md:text-xs">{capitalizeEachWord(campaign?.industry)}</td>
  <td className="py-3 px-4 text-[10px] md:text-xs">
