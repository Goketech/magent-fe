...
>
  <div className="flex justify-between items-center">
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 lg:gap-10 mt-2">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm">{campaign.publishersCount || 12}</p>
        </div>
        <div>
    ...
    <div className="absolute top-0 right-0">
      <span className={`${getStatusBadgeClass(campaign.status)} text-xs px-3 sm:px-6 py-1 sm:py-2 rounded-bl-md`}>
        {campaign.status}
      </span>
    </div>
  </div>
  ...
  <div>
    ...
    <div className="space-y-3 sm:space-y-4">
      {[
        ...
        <div key={index} className="flex justify-between items-start sm:items-center">
          <p className="text-xs sm:text-sm text-gray-600 flex-1 pr-2">{item.label}</p>
          <p className="text-xs sm:text-sm font-medium text-right flex-1">{item.value}</p>
        </div>
      ))}
    </div>
    ...
    <div className="flex mt-3 sm:mt-4 gap-2">
      ...
      {formAnalytics && showAnalytics && (
        <div className="mt-4 sm:mt-8 border-t pt-4 sm:pt-6">
          ...
          >
            <h4 className="font-medium mb-2 text-white text-sm sm:text-base">Form Information</h4>
          ...
          {formAnalytics.fieldAnalytics && Object.keys(formAnalytics.fieldAnalytics).length > 0 && (
            <div className="bg-white border rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
              <h4 className="font-medium mb-3 sm:mb-4 text-sm sm:text-base">Field Responses</h4>
              <div className="space-y-3 sm:space-y-4">
                {Object.entries(formAnalytics.fieldAnalytics).map(([fieldId, fieldData]) => (
                  <div key={fieldId} className="border-b pb-3 sm:pb-4 last:border-b-0">
                    ...
                    <div className="space-y-2">
                      {fieldData.responses && fieldData.responses.length > 0 ? (
                        ...
                        <div className="text-xs sm:text-sm text-gray-500 italic">No responses yet</div>
                      )}
                    </div>
                  </div>
                ))}
          ...
          <div className="bg-white border rounded-lg p-3 sm:p-4">
            <h4 className="font-medium mb-2 text-sm sm:text-base">Last Submission</h4>
          ...
          {formAnalytics.recentSubmissions.length > 0 && (
            <div className="mt-4 bg-white border rounded-lg p-3 sm:p-4">
              <h4 className="font-medium mb-2 text-sm sm:text-base">Recent Submissions</h4>
              <div className="space-y-2">
