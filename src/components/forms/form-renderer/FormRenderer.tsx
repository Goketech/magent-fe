...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  if (isSubmitted) {
    return (
     <div className="bg-gradient-to-br from-purple-50 to-indigo-100 px-4 py-8 sm:py-12">
  <div className={`form-container ${getThemeClasses()} rounded-2xl px-6 py-10 sm:px-12 sm:py-12 max-w-lg mx-auto mt-10 sm:mt-20`}>
    <div className="text-center">
      <div className="mx-auto flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 mb-5 sm:mb-6 shadow-lg">
        <svg className="h-6 w-6 sm:h-8 sm:w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
        </svg>
      </div>
      <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2 sm:mb-3">Success!</h3>
      <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 leading-relaxed">
        Your feedback has been recorded. 🥳 🎉<br />
        You'll be notified when rewarded.
      </p>
      <button
        onClick={() => setIsSubmitted(false)}
        className="inline-flex items-center px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-medium text-[#330065] bg-purple-50 hover:bg-purple-100 rounded-xl transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#330065] focus:ring-offset-2"
      >
  ...
  <div className="form-container max-w-3xl mx-auto">
    ...
    <div className="mb-6">
      <div className="flex items-center justify-center mb-3">
        <div className="h-1 w-12 bg-gradient-to-r from-[#330065] to-purple-400 rounded-full" />
      </div>
    ...
    {showProgress && visibleFields.length > 0 && (
      <div className="mb-6 sm:mb-8 px-4 sm:px-6 py-4 sm:py-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-100">
    ...
    {/* Error Display */}
    {submitError && (
      <div className="mb-6 px-4 py-3 sm:p-4 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-xl">
        ...
        <div className="pt-6 sm:pt-8 border-t border-gray-100">
          <div className="flex justify-center">
            <button
              ...
              className={`group relative px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-semibold text-white transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#330065] disabled:cursor-not-allowed disabled:transform-none ${
                theme === "minimal"
